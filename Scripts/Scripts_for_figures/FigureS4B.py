...
results_clean = pd.read_csv("../../Data/Growth_recovery_duplication/Data_FigS4B.csv", delimiter = ",", header=0)
...
plt.savefig(r"../../Figures/Supp_figures/FigS4B", format='pdf', dpi=300)
